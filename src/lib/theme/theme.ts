...
export const darkTheme: DefaultTheme = {
    ...
    bg: {
        ...
        grass: {
            calm: {
                enabled: colors.grass[800],
                hover: colors.grass[700],
                active: colors.grass[600],
            },
            loud: {
                enabled: colors.grass[200],
                hover: colors.grass[100],
                active: colors.grass[50],
            },
        },
        emerald: {
            calm: {
                enabled: colors.emerald[800],
                hover: colors.emerald[700],
                active: colors.emerald[600],
            },
            loud: {
                enabled: colors.emerald[200],
                hover: colors.emerald[100],
                active: colors.emerald[50],
            },
        },
        azure: {
            calm: {
                enabled: colors.azure[800],
                hover: colors.azure[700],
                active: colors.azure[600],
            },
            loud: {
                enabled: colors.azure[200],
                hover: colors.azure[100],
                active: colors.azure[50],
            },
        },
        cobalt: {
            calm: {
            ...
            loud: {
                enabled: colors.cobalt[200],
                hover: colors.cobalt[100],
                active: colors.cobalt[50],
            },
        },
    },
    border: {
        ...
        brend: {
            enabled: colors.cobalt[200],
            hover: colors.cobalt[300],
            active: colors.cobalt[400],
        },
        gray: {
            calm: {
                enabled: colors.neutral[700],
    ...
    text: {
        disabled: colors.neutral[500],
        global: {
            primary: colors.cobalt[50],
            secondary: colors.neutral[200],
            primaryInverted: colors.cobalt[800],
            primaryOnDark: colors.cobalt[50],
        },
        brend: {
            enabled: colors.cobalt[200],
